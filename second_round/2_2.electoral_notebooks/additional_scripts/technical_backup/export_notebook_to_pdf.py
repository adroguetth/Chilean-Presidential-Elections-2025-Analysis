...
"""
Notebook to PDF Exporter - Second Round Electoral Analysis
==========================================================
Exports electoral analysis notebooks (EN and ES) for second round to PDF.
...
Structure in Drive:
   ...
   └── second_round/
       └── technical_backup/
           ...
           │   └── electoral_analysis_2025_second_round_EN.pdf
           └── ES/
               ├── electoral_analysis_2025_second_round_EN.ipynb
               └── electoral_analysis_2025_second_round_ES.pdf
...
# ============================================================================
# PATH CONFIGURATION - SECOND ROUND
# ============================================================================
# Notebooks source for second round
NOTEBOOK_EN = Path("second_round/2_2.electoral_notebooks/electoral_analysis_2025_second_round_EN.ipynb")
NOTEBOOK_ES = Path("second_round/2_2.electoral_notebooks/electoral_analysis_2025_second_round_ES.ipynb")

# Temporary directory for PDFs
TEMP_DIR = Path("temp_pdf_second_round")
...
def main():
    print("\n" + "=" * 60)
    print("SECOND ROUND: ELECTORAL ANALYSIS NOTEBOOKS → PDF + GOOGLE DRIVE")
    print("=" * 60)
    ...
    # Create folder structure: second_round/
    print(f"\nCreating/verifying folder structure in Drive...")
    second_round_id = create_or_get_folder(service, "second_round", ROOT_FOLDER_ID)

    # Create technical_backup/
    tech_backup_id = create_or_get_folder(service, "technical_backup", second_round_id)
